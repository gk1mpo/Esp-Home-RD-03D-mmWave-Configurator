...
class EPZoneConfiguratorCard extends HTMLElement {
  ...
  set hass(hass) {
    ...
    const angleDeg = Number(hass.states[`number.${this._selectedDevice}_installation_angle`]?.state || 0);
    const rangeM   = Number(hass.states[`number.${this._selectedDevice}_distance`]?.state || 6);
